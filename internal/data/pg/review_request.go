...
// Это для работы с БД
func (s *ReviewService) CreateReview(review *resources.Review) (int, *resources.APIError) {
	...
	if err != nil {
		...
		return 0, resources.NewAPIError(http.StatusBadRequest, "StatusBadRequest", "Error inserting review into database")
